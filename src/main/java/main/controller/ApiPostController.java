...
public class ApiPostController {
    ...
    @GetMapping()
    private ResponseEntity<PostListResponse> posts(
    ...
    @GetMapping("/search")
    private ResponseEntity<PostListResponse> postSearch(
            @RequestParam(defaultValue = "0") int offset,
            @RequestParam(defaultValue = "10") int limit,
    ...
    @GetMapping("/byDate")
    private ResponseEntity<PostListResponse> postByDate(
            @RequestParam(defaultValue = "0") int offset,
            @RequestParam(defaultValue = "10") int limit,
    ...
    @GetMapping("/byTag")
    private ResponseEntity<PostListResponse> postByTag(
            @RequestParam(defaultValue = "0") int offset,
            @RequestParam(defaultValue = "10") int limit,
    ...
    @GetMapping("/{id}")
    private ResponseEntity<PostResponse> postByID(@PathVariable int id) {
        PostResponse singlePostRequest = postService.getPostByID(id);
    ...
    @PostMapping()
    private ResponseEntity<ResultResponse> addPost(@RequestBody AddPostRequest addPostRequest) {
